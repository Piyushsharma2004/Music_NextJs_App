...
function HeroSection() {
    return (
        <div   className="h-auto md:h-[50rem] dark:bg-black  w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0 md">
            <div className="p-4 relative z-10 w-full text-center">
            <Spotlight
        className="-top-50 left-0 md:left-60 md:-top-60"
        fill="white"
      />
                ...
                <p className="mt-8 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">Dive into our comprehensive music courses and
